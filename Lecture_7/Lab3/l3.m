...
% **CORRECTION MADE HERE:** Fixed the meshgrid syntax
...
% NOTE: ifftshift and real() are crucial for proper reconstruction
...
% Spatial Gaussian filter (separable convolution)
